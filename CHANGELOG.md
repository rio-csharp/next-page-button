...
**Features:**
- ✅ Add previous and next page navigation buttons at the bottom of each document
- ✅ Display document position indicator (e.g., 3 / 10)
- ✅ Support multiple notebooks
- ✅ Real-time response to document tree changes (create, delete, move, rename)
- ✅ Perfect theme integration with SiYuan's design system
- ✅ Disabled state with no interaction feedback
- ✅ Support for manually reordered documents (drag & drop)

**Technical Highlights:**
- Use SiYuan's `listDocsByPath` API for accurate document order
